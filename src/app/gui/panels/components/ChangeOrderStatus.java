...
import app.gui.frames.Cashier;
import app.gui.frames.Delivery;
...
import app.models.order.OrderProcessor;
...
public class ChangeOrderStatus extends CustomizedJDialog {
    ...
    public ChangeOrderStatus(MainFrame parent, boolean modal, Order order) {
        super(parent, modal);
        this.Parent = parent;
        ...
        setSize(1200, 600);
        init();
        showButtonsPanel(parent);
    }

    private void init() {
        setLocationRelativeTo(null);
        jScrollPane1.getVerticalScrollBar().setUI(null);
        changeOrderStatusButtonPanel.setVisible(false);
        setupCloseIcon();
        loadOrderItemData();
    }

    private void showButtonsPanel(MainFrame Frame) {
        OrderStatus[] enumList;
        if (Frame instanceof Kitchen) {
            enumList = OrderStatus.KitchenProcessEnums();
        } else if (Frame instanceof Cashier) {
            enumList = OrderStatus.CashierProcessEnums();
        } else if (Frame instanceof Delivery) {
            enumList = OrderStatus.DeliveryProcessEnums();
        } else {
            return;
        }

        for (OrderStatus enumItem : enumList) {
            if (enumItem == getCurrentOrder().getOrderStatus()) {
                changeOrderStatusButtonPanel.setVisible(true);
                break;
            }
        }
    }
    ...
    private double generateItemPriceTotal(OrderItem item) {
    ...
    private void approvalProcess() {
        OrderProcessor.getInstance().getCompleteOrderProcesser().processOrder(CurrentOrder);
        getParent().getServices().loadOrderData(CurrentOrderStatus, getParent().getContentTable());
        System.out.println(getParent().getServices());
        new Thread(() -> {
            setGlassPane(new ChangeOrderStatusGlassPane(getCurrentOrder().getOrderStatus()));
    ...
    private void initComponents() {
        ...
        changeOrderStatusLabel = new javax.swing.JLabel();
        changeOrderStatusButtonPanel = new javax.swing.JPanel();
        ...
        changeOrderStatusLabel.setFont(new java.awt.Font("Rajdhani SemiBold", 0, 12)); // NOI18N
        changeOrderStatusLabel.setForeground(new java.awt.Color(102, 102, 102));
        changeOrderStatusLabel.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        changeOrderStatusLabel.setText("<html>   <p style=\"text-align:start\">Lorem ipsum dolor sit amet, consectetur adipiscing elit.   </p> </html> ");

        changeOrderStatusButtonPanel.setBackground(new java.awt.Color(255, 255, 255));
        ...
        javax.swing.GroupLayout changeOrderStatusButtonPanelLayout = new javax.swing.GroupLayout(changeOrderStatusButtonPanel);
        changeOrderStatusButtonPanel.setLayout(changeOrderStatusButtonPanelLayout);
        changeOrderStatusButtonPanelLayout.setHorizontalGroup(
            changeOrderStatusButtonPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, changeOrderStatusButtonPanelLayout.createSequentialGroup()
                .addGap(0, 0, Short.MAX_VALUE)
        ...
        changeOrderStatusButtonPanelLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {approveOrder, declineOrder});

        changeOrderStatusButtonPanelLayout.setVerticalGroup(
            changeOrderStatusButtonPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(changeOrderStatusButtonPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addComponent(changeOrderStatusLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 493, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(changeOrderStatusButtonPanel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        jPanel3Layout.setVerticalGroup(
            jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
            .addComponent(changeOrderStatusLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
            .addComponent(changeOrderStatusButtonPanel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
...
//        OrderProcessor.getCompleteOrderProcesserInstance().processOrder(CurrentOrder);
        getParent().getServices().loadOrderData(CurrentOrderStatus, getParent().getContentTable());
        dispose();
    ...
    private javax.swing.JPanel changeOrderStatusButtonPanel;
    private javax.swing.JLabel changeOrderStatusLabel;
